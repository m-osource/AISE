...
> The comprehensive technical specification for the L7 XDP/OpenBSD integration (`L7_DEFENSE_SPECIFICATION.md`) is currently undergoing final review and translation, and will be published in an upcoming commit.
